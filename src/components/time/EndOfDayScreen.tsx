    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: 'rgba(26,18,8,0.5)' }}>
      <div className="w-full max-w-sm mx-4 rounded-2xl shadow-2xl overflow-hidden" style={{ background: 'white' }}>
        ...
        <div className="px-6 pt-6 pb-4 text-center" style={{ background: 'linear-gradient(160deg, #f5f0e8 0%, #ede8e0 100%)' }}>
          ...
          <div className="font-semibold" style={{ color: '#1a1208' }}>오늘 업무 종료</div>
          <div className="text-sm mt-1" style={{ color: '#9c8c6e' }}>수고했어요!</div>
        </div>

        {/* Stats */}
        <div className="px-6 py-4 border-b" style={{ borderColor: '#e0d8cc' }}>
          <div className="text-xs font-semibold uppercase tracking-wide mb-3" style={{ color: '#9c8c6e' }}>오늘의 결산</div>
          <div className="grid grid-cols-3 gap-3 text-center">
            <div className="rounded-xl py-3" style={{ background: '#faf5ec' }}>
              ...
              <div className="text-xs mt-0.5" style={{ color: '#9c8c6e' }}>총 XP</div>
            </div>
            <div className="rounded-xl py-3" style={{ background: '#faf5ec' }}>
              <div className="font-mono font-semibold" style={{ color: '#8a6530' }}>{learnedCount}</div>
              <div className="text-xs mt-0.5" style={{ color: '#9c8c6e' }}>학습 표현</div>
            </div>
            <div className="rounded-xl py-3" style={{ background: '#faf5ec' }}>
              <div className="font-mono font-semibold" style={{ color: '#8a6530' }}>Lv.{level}</div>
              <div className="text-xs mt-0.5" style={{ color: '#9c8c6e' }}>레벨</div>
            </div>
          </div>
        </div>
        ...
        {/* Tomorrow teaser */}
        <div className="px-6 py-4 border-b" style={{ borderColor: '#e0d8cc' }}>
          <div className="text-xs font-semibold uppercase tracking-wide mb-2" style={{ color: '#9c8c6e' }}>내일 예고 🎬</div>
        ...
        <div className="px-6 py-4">
          ...
          <p className="text-center text-xs mt-2" style={{ color: '#9c8c6e' }}>모든 기능은 정상적으로 이용 가능합니다</p>
        </div>
      </div>
    </div>
  )
